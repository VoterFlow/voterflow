...
define("LANG_STEP0_INTROTEXT", "<p>You’re about to install the VoterFlow software for vote/poll creation and participation. Because the software is released under the GNU Affero General Public License 3 or any later version of this license, it is <a href=\"http://en.wikipedia.org/wiki/Free_software\">free software</a> as <a href=\"http://www.gnu.org/philosophy/free-sw.html\">defined</a> by the <a href=\"http://www.fsf.org/\">Free Software Foundation</a>. The next step of the installation will show you the full text of the license, to which you agree by using the software. A short overview over the permissions you obtain:</p>".
                               "<ul>".
                               "  <li>You have permission to run the software for any purpose you want. If you run the software in a way that users on a network can cause a usage of the software (for instance, if you run it as a service), you are required to provide a way by which users of that network can obtain a copy of the software you run (you are required to meet the conditions for distributing the software).</li>".
                               ...
                               "<p>But:</p>".
                               "<ul>".
                               "  <li>Values in the database are not required to be published with the source code, as long as they’re generated by user interaction and are not responsible for the internal workings of the software.</li>".
                               ...
                               "</ul>".
                               "<p>Further notes and recommendations:</p>".
                               "<ul>".
                               "  <li>If you modify the software, you are required to mark out your changes very clearly.</li>".
                               "  <li>If you modify the software, it would be nice of you to inform the <a href=\"https://github.com/voterflow/voterflow\">main repository</a> of the project and the authors of the software (see the AUTHORS file) about your actions. However, you are not required to do so.</li>".
                               ...
                               "  <li>If you spot a license violation (or a case which could be a license violation), please contact the authors of the software. Freedom can only be guarded when it is actively defended against its enemies. Don’t worry, we do not intend to cause trouble to the person who violated the license, we would rather see the person complying with the license terms instead.</li>".
                               "  <li>In case you experience any errors in the software or if you want additional features, you might file an issue for it <a href=\"https://github.com/voterflow/voterflow/issues\">here</a> or contact the authors, if you either don’t want or can’t make the changes yourself. If you implement the changes yourself, it would be nice of you to send us a notification about the changes you’ve made.</li>".
                               "</ul>".
                               "<p>Functional features of the software:</p>".
                               "<ul>".
                               "  <li>Create a vote/poll</li>".
                               "  <li>Participate in a vote/poll</li>".
...
define("LANG_STEP4_ADMININITIALIZATIONDESCRIPTION", "Please create the first member. This member will also be the administrator.");
...
define("LANG_STEP4_DBOPERATIONSUCCEEDED", "Member successfully created.");
